...
findspark.init("/home/youngfit/Desktop/spark")
...
filename = input("Enter which txt file to analyze .. (please exclude extension)? ")
auto_check_complete = False
res = input("Does this need to be cipher decoded (true) or is this already decoded (false)? ")
